...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "settings.theme_nord": {"en": "Nord (calm dark)", "de": "Nord (ruhig dunkel)"},
    "settings.theme_plum": {"en": "Plum (warm dark)", "de": "Pflaume (warm dunkel)"},
    "settings.theme_solarized": {"en": "Solarized (light)",
                                 "de": "Solarized (hell)"},
    "settings.theme_sand": {"en": "Sand (paper)", "de": "Sand (Papier)"},
    ...
    "settings.theme_meme": {"en": "Meme (deep-fried)", "de": "Meme (deep-fried)"},
